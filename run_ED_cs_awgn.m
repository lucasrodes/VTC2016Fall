function run_ED_cs_awgn(RXtech, N, SNR_input)
%RUN_ED_CS_AWGN(RXtech, N, SNR) - This function focuses on a PU complex 
%sinusoid signal with an AWGN channel.
...
if SNR_input>=0
    y1 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_' num2str(SNR_inputSNR) ...
        'SNR_1.mat']);
else
    y1 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_m'...
...
if sum(RXtech(2:5))>0 % If any multiple antenna (L=2) technique is selected
    ...
    if SNR_input>=0
        y2 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_' num2str(SNR_input)...
            'SNR_2.mat']);
    else
        y2 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_m' ...
    ...
    if (RXtech(3)+RXtech(5))>0 % If any multiple antenna (L=4) technique is selected
        ...
        if SNR_input>=0
            y3 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_' num2str(SNR_input)...
                'SNR_3.mat']);
            y4 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_' num2str(SNR_input)...
                'SNR_4.mat']);
        else
            y3 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_m' ...
                num2str(abs(SNR_input)) 'SNR_3.mat']);
            y4 = importdata([files_dir '/Complex Sinusoid/AWGN/H1_m' ...
...
if RXtech(2) 
    ...
    [Texp_h0_var,Texp_h0_pdf,Texp_h1_var,Texp_h1_pdf,Tth_var,...
    Tth_h0_pdf,Tth_h1_pdf,Pd_exp,Pfa_exp,Pd_th,Pfa_th] = ...
    run_ED_cs_awgn_slc2(y1,w1,y2,w2,N);
...
if RXtech(3) 
    ...
    [Texp_h0_var,Texp_h0_pdf,Texp_h1_var,Texp_h1_pdf,Tth_var,...
    Tth_h0_pdf,Tth_h1_pdf,Pd_exp,Pfa_exp,Pd_th,Pfa_th] = ...
    run_ED_cs_awgn_slc4(y1,w1,y2,w2,y3,w3,y4,w4,N);
...
if RXtech(4) 
    ...
    [Texp_h0_var,Texp_h0_pdf,Texp_h1_var,Texp_h1_pdf,Tth_var,...
    Tth_h0_pdf,Tth_h1_pdf,Pd_exp,Pfa_exp,Pd_th,Pfa_th] = ...
    run_ED_cs_awgn_sls2(y1,w1,y2,w2,N);
...
if RXtech(5) 
    ...
    [Texp_h0_var,Texp_h0_pdf,Texp_h1_var,Texp_h1_pdf,Tth_var,...
    Tth_h0_pdf,Tth_h1_pdf,Pd_exp,Pfa_exp,Pd_th,Pfa_th] = ...
    run_ED_cs_awgn_sls4(y1,w1,y2,w2,y3,w3,y4,w4,N);
