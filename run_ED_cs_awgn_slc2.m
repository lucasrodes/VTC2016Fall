...
Tth_h1_pdf = pdf('Normal',Tth_var,a1*Prx1+a2*Prx2,sqrt((a1^2*(2*...
    Prx1*sigma_w1^2-sigma_w1^4)+a2^2*(2*Prx2*sigma_w2^2-sigma_w2^4))/N));
...
for Tk=Tth_var
    ...
    Pd_th(cont) = qfunc((Tk-(a1*Prx1+a2*Prx2))./sqrt((a1^2*(2*...
    Prx1*sigma_w1^2-sigma_w1^4)+a2^2*(2*Prx2*sigma_w2^2-sigma_w2^4))/N));
