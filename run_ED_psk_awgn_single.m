...
%ROC curve, for a PSK-modulated TX signal in an AWGN channel and using 
...
close(h); % Close waitbar
    ...
    warndlg('PSK-AWGN-Single Antenna: This part is still under development');
end
end
