function [Texp_h0_var,Texp_h0_pdf,Texp_h1_var,Texp_h1_pdf,Tth_var,...
    ...
    run_ED_psk_fading_slc(y1,w1,y2,w2,N)
...
%the ROC curve, for a PSK-modulated TX signal in a Rayleigh Fading
...
close(h); % Close waitbar
    ...
    warndlg('PSK-FADING-SLC: This part is still under development');
end
end
