...
T_h0 = max(max(max(T_h0_1,T_h0_2),T_h0_3),T_h0_4);
...
T_h1 = max(max(max(T_h1_1,T_h1_2),T_h1_3),T_h1_4);
...
mu_h1_3 = Prx3;
sigma_h1_3 = sqrt(1/N*(2*Prx3*sigma_w3^2-sigma_w3^4));
mu_h1_4 = Prx4;
sigma_h1_4 = sqrt(1/N*(2*Prx4*sigma_w4^2-sigma_w4^4));
