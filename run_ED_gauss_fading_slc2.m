...
for Tk=Tth_var
    ...
    f = @(g1,g2) 1./(sqrt(2*pi*1/N*(a1^2*(g1.*aP1...
    +sigma_w1^2).^2+a2^2*(g2.*aP2+sigma_w2^2).^2)))...
    .*exp(-(Tk-(a1*(g1.*aP1+sigma_w1^2)+a2*(g2.*aP2+sigma_w2^2)))...
    .^2./(2*1/N*(a1^2*(g1.*aP1+sigma_w1^2).^2+a2^2*...
    (g2.*aP2+sigma_w2^2).^2))) ...
    ...
    ...
    ff = @(g1,g2) qfunc((Tk-(a1*(g1*aP1+sigma_w1^2)+a2*(g2*aP1+...
        sigma_w2^2)))./(sqrt((a1^2*(g1*aP1+sigma_w1^2).^2+...
        a2^2*(g2*aP2+sigma_w2^2).^2)/N)))...
    .*1./(2.*sigma_h^2).*exp(-g1./(2*sigma_h^2))...
    .*1./(2.*sigma_h^2).*exp(-g2./(2*sigma_h^2));
